...
class TagObjectsControllerTest < ActionController::TestCase
  ...
  test "should create tag_object" do
    assert_difference('TagObject.count') do
      post :create, tag_object: { image_object_id: @tag_object.image_object_id, tag_string: @tag_object.tag_string }
    end
  ...
  test "should update tag_object" do
    patch :update, id: @tag_object, tag_object: { image_object_id: @tag_object.image_object_id, tag_string: @tag_object.tag_string }
    assert_redirected_to tag_object_path(assigns(:tag_object))
  end
