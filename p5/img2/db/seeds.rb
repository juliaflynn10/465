...
user = User.create(
        [
                { name:'Stephen Fry', email:'imwhatwillisistalkingabout@gmail.com', encrypted_password:'thugg!n'},
                { name:'Jack Nicholson', email:'2kule4rulez@gmail.com', encrypted_password:'po$$y'},
                { name:'Queen Bey', email:'iwokeuplikethis@gmail.com', encrypted_password:'fl*wless'},
                { name:'Hunter Thompson', email:'nothing2lose@gmail.com', encrypted_password:'st0ckt0n'},
                { name:'Lil Wayne', email:'youngmoney@gmail.com', encrypted_password:'CREAM'},
                { name:'Orbit Britson', email:'lintlicker@gmail.com', encrypted_password:'solarsystem'},
                { name:'No Nah', email:'no@gmail.com', encrypted_password:'no'}
