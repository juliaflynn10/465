users = User.create(
        [
                ...
                { name:'Queen Bey', email:'a@gmail.com', password:'flwless', password_confirmation:'flwless'},
                { name:'Hunter Thompson', email:'nothing2lose@gmail.com', password:'stcktn', password_confirmation:'stcktn'},
