...
class ImageObjectsControllerTest < ActionController::TestCase
  ...
  test "should create image_object" do
    assert_difference('ImageObject.count') do
      post :create, image_object: { filename: @image_object.filename, public: @image_object.public, user_id: @image_object.user_id }
    end
  ...
  test "should update image_object" do
    patch :update, id: @image_object, image_object: { filename: @image_object.filename, public: @image_object.public, user_id: @image_object.user_id }
    assert_redirected_to image_object_path(assigns(:image_object))
  end
